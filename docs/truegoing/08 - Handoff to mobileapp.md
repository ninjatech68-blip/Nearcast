...
Testers who used both apps said MigoMap gets the job done in fewer steps. [`11 - Fewer Steps Same Trust`](./11%20-%20Fewer%20Steps%20Same%20Trust.md) sets targets that keep every trust rule: post in 4 taps on one screen, join in 2 taps with tap-to-send starters, accept in 1 tap from the row or the push, onboard in 3 screens, read the time off the card. Steps 1–5 there are client-only and touch no decision; they can ship before the SMS provider. Step 6, **host-opened plans** (`Anyone verified can join`, one-tap `I'm going`, acceptance immediate and server-side, D2/D5/D17/D29 intact), needs a decision entry first. Where `11` and §5.1 overlap (poster start time, join sheet copy), `11` is the fuller spec. **Owner ruling 2026-09-23:** plans are browsable on a map at their coarse point; `11 §11` carries the draft decision D53 (amends D45 and the brand's map-pin guardrail), the host `Show on the map` toggle (ruled default on), the `Mine | All` chip and the schema and test list. **Owner ruling 2026-09-23:** a group thread per plan for the host and accepted people only; `11 §12` carries the draft decision D54 (amends D2, keeps D13 by making the blocker leave the plan), pair threads retained, schema and test list. **Owner ruling 2026-09-23:** an optional Instagram handle, stored owner-only and shown only after acceptance on a live plan through the same gate as the exact place; `11 §13` carries the draft decision D55, copy, schema and tests. **Owner rulings 2026-09-23 (later):** Apple and Google sign-in with the name prefilled while the phone stays the verification (D56, `11 §14`); map markers carry the plan's icon, never the host's face (D53 amended, `11 §15`); a plan gets a drawn icon suggested from its words and confirmed by the person (D57, `11 §16`).
...
| 2026-09-23 | Recorded the owner ruling on map browse (D53 draft in `11 §11`) |
| 2026-09-23 | Recorded owner rulings: map toggle default on; group thread per plan (D54 draft in `11 §12`) |
| 2026-09-23 | Recorded owner ruling: optional Instagram handle visible only after acceptance (D55 draft in `11 §13`) |
| 2026-09-23 | Recorded owner rulings: Apple/Google sign-in with prefilled name (D56), plan icons on map markers (D53 amended), auto-suggested plan icon (D57) |
