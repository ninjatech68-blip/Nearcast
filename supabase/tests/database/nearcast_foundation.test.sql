...
select has_table('public', 'intent_private', 'private intent data has a separate table');
...
insert into public.intents (
  ...
  'request', 'Need help carrying books this evening', 'live', 'Offer help',
...
values ('10000000-0000-0000-0000-000000000001', '42 Private Lane', '+910000000000');
...
select is_empty(
  $$ select exact_address from public.intent_private where intent_id = '10000000-0000-0000-0000-000000000001' $$,
  'delivered recipient cannot read exact private details'
);
...
select results_eq(
  $$ select exact_address from public.intent_private where intent_id = '10000000-0000-0000-0000-000000000001' $$,
  array['42 Private Lane'::text],
  'broadcaster can read own private intent details'
);
