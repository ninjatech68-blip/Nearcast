...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: 'Manrope_700Bold', fontSize: 16, lineHeight: 23, textAlign: 'center', color: tokens.semantic.color.textPrimary },
  prompt: { marginTop: 34, fontFamily: 'Manrope_700Bold', fontSize: 24, lineHeight: 30, color: tokens.semantic.color.textPrimary },
  chips: { flexDirection: 'row', gap: 0, marginTop: 18, overflow: 'hidden', borderWidth: 1, borderColor: tokens.semantic.color.borderSubtle, borderRadius: 12, backgroundColor: tokens.semantic.color.backgroundSurface },
  ...
  chipSelected: { borderColor: tokens.semantic.color.actionPrimary, backgroundColor: tokens.semantic.color.backgroundSuccess },
  ...
  privacyBody: { marginTop: 4, fontFamily: 'Manrope_400Regular', fontSize: 13, lineHeight: 18, color: tokens.semantic.color.actionPrimary },
  footer: { marginTop: 'auto', padding: 20, borderTopWidth: 1, borderTopColor: tokens.semantic.color.borderSubtle },
});
